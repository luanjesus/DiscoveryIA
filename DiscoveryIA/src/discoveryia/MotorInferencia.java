...
public class MotorInferencia {
    ...
    public MotorInferencia(ArrayList<Regras> r,String proxR) throws IOException {
        this.regra = r;
    ...
    public void MotorInferencia(ArrayList<Regras> r, String proxRegra) throws IOException{
    
        this.regra = r; 
        String reg,per,respt,respf,resut,resuf, opcao;
        Regras re = new Regras();
